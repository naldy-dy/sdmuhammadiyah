...
<head>
	...
	<!-- Favicon -->   
	<link href="{{url('public')}}/assets-landing/img/favicon.ico" rel="shortcut icon"/>
...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- logo -->
			<a href="index.html" class="site-logo"><img src="{{url('public')}}/assets-landing/img/logo.png" alt=""></a>
			...
			<div class="header-info">
				<div class="hf-item">
					...
					<p><span>Waktu Pelajaran:</span>Monday - Friday: 08 AM - 06 PM</p>
				</div>
				<div class="hf-item">
					<i class="fa fa-map-marker"></i>
					<p><span>Alamat:</span>40 Baria Street 133/2, New York City, US</p>
				</div>
			</div>
		</div>
	</header>
        ...
        <ul class="main-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{url('tentang')}}">Sambutan Kepala Sekolah</a></li>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="{{url('public')}}/assets-landing/img/hero-slider/1.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
	...
	<!-- Enroll section -->
	<section class="enroll-section spad set-bg" data-setbg="{{url('public')}}/assets-landing/img/enroll-bg.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
	...
	<div class="gallery-section">
		<div class="gallery">
			...
			<div class="gallery-item set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/2.jpg">
				<a class="img-popup" href="img/gallery/2.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/3.jpg">
				<a class="img-popup" href="img/gallery/3.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-long set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/5.jpg">
				<a class="img-popup" href="img/gallery/5.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-big set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/8.jpg">
				<a class="img-popup" href="img/gallery/8.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-long set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/4.jpg">
				<a class="img-popup" href="img/gallery/4.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/6.jpg">
				<a class="img-popup" href="img/gallery/6.jpg"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="{{url('public')}}/assets-landing/img/gallery/7.jpg">
